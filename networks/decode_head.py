...
class BaseDecodeHead(nn.Module, metaclass=ABCMeta):
    ...
    def loss(self, inputs: Tuple[Tensor], batch_data_samples: List,
             train_cfg: EasyDict) -> dict:
    ...
    def _stack_batch_gt(self, batch_data_samples: List) -> Tensor:
        gt_semantic_segs = [
    ...
    def loss_by_feat(self, seg_logits: Tensor,
        ...
        print('need accuracy calculation')
